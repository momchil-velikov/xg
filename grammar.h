...
enum xg_assoc { xg_assoc_unknown, xg_assoc_none, xg_assoc_left, xg_assoc_right };

/* Symbol kind.  */
enum xg_sym_kind { xg_implicit_terminal, xg_explicit_terminal, xg_non_terminal };
...
int xg_make_random_sentence(FILE *out, const xg_grammar *g, unsigned int size, int names);
